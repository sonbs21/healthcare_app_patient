...
class HeartbeatTable extends StatefulWidget {
  @override
  _HeartbeatTableState createState() => _HeartbeatTableState();
}

class _HeartbeatTableState extends State<HeartbeatTable> {
  ...
  Widget buildDataTable() {
    final columns = ['Ngày', 'Tâm thu', 'Tâm trương'];
